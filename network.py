...
# Optional PyTorch path — activates if torch is installed
try:
    import torch
...
class ActorCriticNetwork:
    ...
    def act(
        ...
        if greedy:
            ...
            # Handle both 1D and 2D probs arrays
            probs_1d = probs if probs.ndim == 1 else probs.squeeze()
            idx = int(self._rng.choice(len(probs_1d), p=probs_1d))
